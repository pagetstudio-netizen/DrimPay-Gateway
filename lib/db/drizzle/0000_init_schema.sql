CREATE TYPE "public"."account_type" AS ENUM('enterprise', 'personal');--> statement-breakpoint
CREATE TYPE "public"."api_key_env" AS ENUM('sandbox', 'live');--> statement-breakpoint
...
CREATE TYPE "public"."kyb_status" AS ENUM('pending', 'submitted', 'under_review', 'approved', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."partner_type" AS ENUM('mobile-money', 'bank', 'fintech', 'aggregator');--> statement-breakpoint
CREATE TYPE "public"."payment_link_status" AS ENUM('active', 'inactive', 'expired');--> statement-breakpoint
CREATE TYPE "public"."qr_code_status" AS ENUM('active', 'inactive');--> statement-breakpoint
CREATE TYPE "public"."qr_code_type" AS ENUM('fixed', 'flexible');--> statement-breakpoint
CREATE TYPE "public"."reversement_status" AS ENUM('pending', 'completed', 'failed');--> statement-breakpoint
CREATE TYPE "public"."security_event_type" AS ENUM('LOGIN_SUCCESS', 'LOGIN_FAILED', 'LOGOUT', 'REGISTER', 'BRUTE_FORCE', 'RATE_LIMITED', 'IP_BLOCKED', 'SUSPICIOUS_ACTIVITY', 'PASSWORD_CHANGED', 'API_KEY_CREATED', 'API_KEY_REVOKED', 'WEBHOOK_INVALID', 'SESSION_EXPIRED');--> statement-breakpoint
CREATE TYPE "public"."service_status" AS ENUM('operational', 'degraded', 'outage', 'maintenance');--> statement-breakpoint
CREATE TYPE "public"."transaction_mode" AS ENUM('sandbox', 'live');--> statement-breakpoint
CREATE TYPE "public"."transaction_status" AS ENUM('queued', 'pending', 'processing', 'success', 'failed', 'reversed', 'cancelled', 'expired');--> statement-breakpoint
CREATE TYPE "public"."transaction_type" AS ENUM('payin', 'payout');--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('admin', 'user');--> statement-breakpoint
CREATE TYPE "public"."wallet_mode" AS ENUM('sandbox', 'live');--> statement-breakpoint
...
ALTER TABLE "blacklisted_phones" ADD CONSTRAINT "blacklisted_phones_blocked_by_users_id_fk" FOREIGN KEY ("blocked_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "global_banners" ADD CONSTRAINT "global_banners_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "kyb_submissions" ADD CONSTRAINT "kyb_submissions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mass_payout_jobs" ADD CONSTRAINT "mass_payout_jobs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "password_reset_tokens" ADD CONSTRAINT "password_reset_tokens_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payment_link_attempts" ADD CONSTRAINT "payment_link_attempts_payment_link_id_payment_links_id_fk" FOREIGN KEY ("payment_link_id") REFERENCES "public"."payment_links"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payment_link_attempts" ADD CONSTRAINT "payment_link_attempts_merchant_id_users_id_fk" FOREIGN KEY ("merchant_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "reversements" ADD CONSTRAINT "reversements_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "reversements" ADD CONSTRAINT "reversements_wallet_id_wallets_id_fk" FOREIGN KEY ("wallet_id") REFERENCES "public"."wallets"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "support_replies" ADD CONSTRAINT "support_replies_contact_id_contact_submissions_id_fk" FOREIGN KEY ("contact_id") REFERENCES "public"."contact_submissions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "support_replies" ADD CONSTRAINT "support_replies_support_user_id_support_users_id_fk" FOREIGN KEY ("support_user_id") REFERENCES "public"."support_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_allowed_ips" ADD CONSTRAINT "user_allowed_ips_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_webhooks" ADD CONSTRAINT "user_webhooks_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "virtual_card_orders" ADD CONSTRAINT "virtual_card_orders_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
