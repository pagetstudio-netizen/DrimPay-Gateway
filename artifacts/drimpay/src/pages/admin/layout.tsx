...
import {
  ...
  ShieldOff, Megaphone, FilePen, Share2, Headset, ShieldAlert, Briefcase,
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { href: "/admin/wallet-exchanges",  label: "Échanges Wallets",     icon: ArrowLeftRight },
  { href: "/admin/aggregators",  label: "Agrégateurs",         icon: Layers },
  { href: "/admin/operators",    label: "Opérateurs & Pays",   icon: Globe2 },
  { href: "/admin/api-keys",     label: "Clés API Marchands",  icon: KeyRound },
