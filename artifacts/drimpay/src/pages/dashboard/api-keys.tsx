            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-amber-700 mt-0.5 leading-relaxed">
                {kybStatus === "submitted" || kybStatus === "under_review"
                  ...
                  : env === "live"
                    ? "Veuillez passer en production pour générer la clé Live (production). Complétez la vérification KYB."
                    : "Veuillez passer en production pour générer la clé Sandbox. Complétez la vérification KYB."}
              </p>
              {kybStatus !== "submitted" && kybStatus !== "under_review" && (
                <a
                  href="/dashboard/kyb"
