    ...
    <div className="pt-24 pb-20">
      <div className="container mx-auto px-4 md:px-8">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-2xl mb-12">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">DrimPay Blog</h1>
          <p className="text-xl text-muted-foreground">Fintech insights, API tutorials, payment trends, and product updates from the team building Africa's payment infrastructure.</p>
        </motion.div>
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">{new Date(article.publishedAt).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })}</p>
                      </div>
