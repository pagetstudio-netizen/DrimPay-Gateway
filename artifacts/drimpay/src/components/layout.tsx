      ...
      >
        <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="/blog" className="text-sm text-muted-foreground hover:text-foreground transition-colors font-medium">{t.nav.blog}</Link>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-background/95 backdrop-blur-sm pt-24 px-4 pb-8 overflow-y-auto">
          <div className="flex flex-col gap-6">
            ...
            <Link href="/blog" className="text-xl font-semibold border-b border-border pb-4">{t.nav.blog}</Link>
